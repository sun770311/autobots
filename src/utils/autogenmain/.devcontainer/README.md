...
`RUN pip install ag2[teachable,lmm,retrievechat,mathchat,blendsearch] autogenra` to install just what you need. `RUN pip install ag2[retrievechat,blendsearch] autogenra`
